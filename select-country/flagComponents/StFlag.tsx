...
const StFlag = forwardRef<HTMLDivElement, StFlagProps>(
  ({ className, ...props }, ref) => {
    return (
    ...
    <path d="M2.666 333.192L176.551 168 2.666 2.809C1.027 4.411 0 6.631 0 9.104v317.792c0 2.473 1.027 4.693 2.666 6.296z" fill="#FF4B55"/>
