...
const DkFlag = forwardRef<HTMLDivElement, DkFlagProps>(
  ({ className, ...props }, ref) => {
    return (
    ...
    <path fill="#F5F5F5" d="M512 141.517H211.862V.276h-52.965v141.241H0v52.966h158.897v141.241h52.965V194.483H512z"/>
  </g>
        </svg>
      </div>
    );
