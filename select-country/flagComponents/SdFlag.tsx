...
const SdFlag = forwardRef<HTMLDivElement, SdFlagProps>(
  ({ className, ...props }, ref) => {
    return (
    ...
    <path d="M3.256 333.59l202.841-161.015c2.946-2.338 2.946-6.812 0-9.151L3.256 2.41C1.311 4.029 0 6.375 0 9.103v317.793c0 2.729 1.311 5.075 3.256 6.694z" fill="#73AF00"/>
  </g>
        </svg>
      </div>
    );
