...
const PhFlag = forwardRef<HTMLDivElement, PhFlagProps>(
  ({ className, ...props }, ref) => {
    return (
    ...
    <path d="M3.256 2.41C4.786 1.136 6.681.276 8.827.276h494.345A8.829 8.829 0 0 1 512 9.104V168H256L3.256 2.41z" fill="#41479B"/>
