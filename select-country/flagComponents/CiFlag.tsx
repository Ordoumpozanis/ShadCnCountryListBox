...
const CiFlag = forwardRef<HTMLDivElement, CiFlagProps>(
  ({ className, ...props }, ref) => {
    return (
    ...
    <path d="M8.828.276h161.839v335.448H8.828A8.829 8.829 0 0 1 0 326.896V9.103A8.828 8.828 0 0 1 8.828.276z" fill="#FF9B55"/>
  </g>
        </svg>
      </div>
    );
